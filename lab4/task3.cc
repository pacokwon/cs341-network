...
Task3::CreateNodes ()
{
  ...
  /* posAllocator->Add (Vector( 0,  0, 0)); // A */
  /* posAllocator->Add (Vector( 0, 50, 0)); // B */
  /* posAllocator->Add (Vector(40, 10, 0)); // C */
  /* posAllocator->Add (Vector(50,  0, 0)); // D */
  /* posAllocator->Add (Vector(50, 50, 0)); // E */
  /* posAllocator->Add (Vector(100, 50, 0)); // F */

  posAllocator->Add (Vector(-15, 0, 0)); // A
  posAllocator->Add (Vector( 15, 0, 0)); // B
  posAllocator->Add (Vector(39.21, 17.72, 0)); // C
  posAllocator->Add (Vector(0, 48.74, 0)); // D
  posAllocator->Add (Vector(-39.21, 17.72, 0)); // E
